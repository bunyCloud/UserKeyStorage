...
import { Box, Button, Input, FormControl, Center, VStack, useToast, Text, HStack } from '@chakra-ui/react'
      ...
      <Box bg="ghostwhite" w="100%" mt={0} p={4} border="0.5px solid silver">
        <Box p={4} border="0.5px solid silver" bg="white">
          ...
          <HStack>
            ...
            <Button variant={'link'} size={'sm'} colorScheme="twitter" href={`https://testnet.teloscan.io/address/${contractAddress}`}>
              View on Explorer
            </Button>
          </HStack>
     <HStack>
